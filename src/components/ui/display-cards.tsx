...
export default function DisplayCards({ cards }: DisplayCardsProps) {
  const defaultCards = [
    ...
    {
      className: "[grid-area:stack] translate-x-6 md:translate-x-16 translate-y-5 md:translate-y-10 hover:-translate-y-1 before:absolute before:w-[100%] before:outline-1 before:rounded-xl before:outline-border before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-background/50 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration:700 hover:grayscale-0 before:left-0 before:top-0",
    },
    {
      className: "[grid-area:stack] translate-x-12 md:translate-x-32 translate-y-10 md:translate-y-20 hover:translate-y-5 md:hover:translate-y-10",
    },
  ];
  ...
  return (
    <div className="grid [grid-template-areas:'stack'] place-items-start opacity-100 animate-in fade-in-0 duration-700 overflow-hidden max-w-[95vw] ml-4 pl-4 pr-12">
