...
const indicatii = ["Screening mamar la risc crescut", "Evaluare leziuni detectate la mamografie", "Suspiciune de cancer mamar", "Monitorizare cicatrici post-operatorii", "Evaluare pre-operatorie", "Controlul eficacității tratamentului", "Identificarea cancerului multicentrik", "Screening la portătoarele BRCA"];
const avantaje = ["Sensibilitate ridicată pentru cancer", "Fără radiații ionizante", "Evaluare țesuturilor dense", "Detectare precoce de leziuni", "Caracterizarea precisă a leziunilor", "Evaluare bilaterală simultană"];
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        animationDelay: '0.1s'
          ...
          <AnimatedCard>
            ...
            <p className="text-muted-foreground leading-relaxed text-center">RMN mamar este cea mai sensibilă metodă imagistică pentru detectarea cancerului de sân, oferind imagini detaliate ale întregii structuri mamare. Această investigație este esențială pentru femeile cu risc crescut și pentru evaluarea completă a leziunilor mamare, implanturilor etc.</p>
          </AnimatedCard>
        </section>
