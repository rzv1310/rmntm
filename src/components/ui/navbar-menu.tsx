...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative border border-border bg-background/95 backdrop-blur-md shadow-medium flex justify-center space-x-8 px-8 py-4" style={{borderRadius: '10px'}}
    >
      {children}
    </nav>
  );
