...
function FloatingPaths({
  ...
  return <div className="absolute inset-0 pointer-events-none">
      <svg className="w-full h-full text-white" viewBox="0 0 696 316" fill="none">
        ...
        {paths.map(path => <motion.path key={path.id} d={path.d} stroke="currentColor" strokeWidth={path.width} strokeOpacity={0.15 + path.id * 0.02} initial={{
        pathLength: 0.3,
        opacity: 0.4
      }} animate={{
        pathLength: 1,
  ...
  return <div className="min-h-screen">
        ...
        <div className="relative min-h-[600px] flex items-center bg-neutral-950">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center text-white">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-in-up">RMN TIMIȘOARA</h1>
              <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto leading-relaxed animate-fade-in-up font-normal">Imagistică de încredere în Timișoara, cu programare și rezultate rapide!</p>
      ...
      <section className="py-20 bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {services.map(service => <div key={service.href} className="scroll-reveal">
                <ServiceCard {...service} />
              </div>)}
          </div>
          ...
          <div className="scroll-reveal">
            <Link to="/servicii" className="block hover:scale-105 transition-transform duration-200">
              <HandWrittenTitle title="Vezi toate" subtitle="examinările RMN" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="scroll-reveal">
            <FaqAccordion data={faqs} className="max-w-[700px] mx-auto" timestamp="" questionClassName="!bg-transparent hover:!bg-transparent !text-black" answerClassName="!bg-black !text-white" />
          </div>
        </div>
      </section>
